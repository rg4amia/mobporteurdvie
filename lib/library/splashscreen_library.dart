...
class SplashScreen extends StatefulWidget {
  ...
  late Text loadingText;

  /// Padding for long Loading text, default: EdgeInsets.all(0)
  late EdgeInsets? loadingTextPadding;

  ///  Background image for the entire screen
  late ImageProvider? imageBackground;

  /// Background gradient for the entire screen
  late Gradient? gradientBackground;
  ...
  late Future<Object>? navigateAfterFuture;
