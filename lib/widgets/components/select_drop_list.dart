...
class SelectDropList extends StatefulWidget {
  ...
  SelectDropList(this.itemSelected, this.dropListModel,this.icon, this.onOptionSelected);

  @override
  _SelectDropListState createState() =>
      _SelectDropListState(itemSelected, dropListModel,icon);
}
...
class _SelectDropListState extends State<SelectDropList>
  ...
  _SelectDropListState(this.optionItemSelected, this.dropListModel,this.icon);
